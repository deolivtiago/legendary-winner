defmodule ClarxCore.Accounts.Users.UserTest do
  ...
  describe "changeset/1 returns a valid changeset" do
    test "when full name is valid", %{attrs: attrs} do
  ...
  describe "changeset/1 returns an invalid changeset" do
    test "when full name is too short", %{attrs: attrs} do
    ...
    test "when full name is empty", %{attrs: attrs} do
      attrs = Map.put(attrs, :full_name, "")
  ...
  describe "changeset/2 returns a valid changeset" do
    ...
    test "when full name is valid", %{attrs: attrs, user: user} do
      changeset = User.changeset(user, attrs)
  ...
  describe "changeset/2 returns an invalid changeset" do
    ...
    test "when full name is too short", %{attrs: attrs, user: user} do
      attrs = Map.put(attrs, :full_name, "?")
    ...
    test "when full name is empty", %{attrs: attrs, user: user} do
      attrs = Map.put(attrs, :full_name, "")
